...
{
	$default = array(
		'no-repeat' => esc_html__('No Repeat', 'hafezkids'),
		'repeat-x'  => esc_html__('Repeat Horizontally', 'hafezkids'),
		'repeat-y'  => esc_html__('Repeat Vertically', 'hafezkids'),
		'repeat'    => esc_html__('Repeat All', 'hafezkids'),
	);
...
{
	$default = array(
		'top left'      => esc_html__('Top Left', 'hafezkids'),
		'top center'    => esc_html__('Top Center', 'hafezkids'),
		'top right'     => esc_html__('Top Right', 'hafezkids'),
		'center left'   => esc_html__('Middle Left', 'hafezkids'),
		'center center' => esc_html__('Middle Center', 'hafezkids'),
		'center right'  => esc_html__('Middle Right', 'hafezkids'),
		'bottom left'   => esc_html__('Bottom Left', 'hafezkids'),
		'bottom center' => esc_html__('Bottom Center', 'hafezkids'),
		'bottom right'  => esc_html__('Bottom Right', 'hafezkids')
	);
...
{
	$default = array(
		'scroll' => esc_html__('Scroll Normally', 'hafezkids'),
		'fixed'  => esc_html__('Fixed in Place', 'hafezkids')
	);
...
{
	$default = array(
		'auto' => esc_html__('Auto', 'hafezkids'),
		'cover'  => esc_html__('Cover', 'hafezkids'),
		'contain'  => esc_html__('Contain', 'hafezkids'),
		'initial'  => esc_html__('Initial', 'hafezkids'),
...
{
	$default = array(
		'left' => esc_html__('Left', 'hafezkids'),
		'center'  => esc_html__('Center', 'hafezkids'),
		'right'  => esc_html__('Right', 'hafezkids'),
...
function of_recognized_font_faces()
{
	return apply_filters(
		...
		array_merge(hafez_get_safe_webfonts(), hafez_get_google_webfonts())
	);
}
...
{
	$default = array(
		'normal'      => esc_html__('Normal', 'hafezkids'),
		'italic'      => esc_html__('Italic', 'hafezkids'),
		'bold'        => esc_html__('Bold', 'hafezkids'),
		'bold italic' => esc_html__('Bold Italic', 'hafezkids')
	);
...
{
	$default = array(
		'none'      => esc_html__('None', 'hafezkids'),
		'capitalize'      => esc_html__('Capitalize', 'hafezkids'),
		'uppercase'        => esc_html__('Uppercase', 'hafezkids'),
		'lowercase' => esc_html__('Lowercase', 'hafezkids')
	);
	return apply_filters('of_recognized_font_styles', $default);
}
...
{
	$default = array(
		'200' => esc_html__('Extra-Light 200', 'hafezkids'),
		'300' => esc_html__('Light 300', 'hafezkids'),
		'400' => esc_html__('Regular 400', 'hafezkids'),
		'500' => esc_html__('Medium 500', 'hafezkids'),
		'600' => esc_html__('Semi-Bold 600', 'hafezkids'),
		'700' => esc_html__('Bold 700', 'hafezkids'),
		'800' => esc_html__('Extra-Bold 800', 'hafezkids'),
		'900' => esc_html__('Ultra-bold 900', 'hafezkids')
	);
