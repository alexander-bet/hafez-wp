jQuery(function ($) {
    ...
    function resetIndex() {
        $('#gallery-metabox-list li').each(function (i) {
            $(this).find('input:hidden').attr('name', 'hafez_gallery_id[' + i + ']');
        });
    }
